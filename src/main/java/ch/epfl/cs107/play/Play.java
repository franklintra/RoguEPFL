...
public class Play {
	...
	public static final int WINDOW_HEIGHT = ch.epfl.cs107.play.game.icrogue.constants.windowSize;
	public static final int WINDOW_WIDTH = ch.epfl.cs107.play.game.icrogue.constants.windowSize;
